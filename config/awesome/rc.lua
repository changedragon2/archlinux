...
--[[==============================================================
    ##############ff0000 Required libraries #ff0000###############
    ==============================================================]]
...
local theme_conf_dir = os.getenv("HOME") .. "/.config/awesome/"


--[[==============================================================
    ################ffff00 Error handling #ffff00#################
    ==============================================================]]
...
--[[==============================================================
    ##############00ff00 Autostart windowless processes #00ff00###
    ==============================================================]]
-- component -picom-
...
--[[==============================================================
    ###############0000ff Variable definitions #0000ff############
    ==============================================================]]
local themes = {
    "blackburn",       -- 1
    "copland",         -- 2
...
local picom         = "picom -b --config " .. theme_conf_dir .. "picom.conf"
local prtsc         = "maim $HOME/Pictures/Screenshots/$(date '+%Y-%m-%d-%H:%M:%S').png"
local prtsc_custom  = "maim -s $HOME/Pictures/Screenshots/$(date '+%Y-%m-%d-%H:%M:%S').png"
...
globalkeys = mytable.join(
    ...
    awful.key({ "Control" }, "Left", function () lain.util.tag_view_nonempty(-1) end,
              {description = "view  previous/next nonempty", group = "tag"}),
    ...
    --[[ Dynamic tagging
    awful.key({ modkey, "Shift" }, "e", function () lain.util.add_tag() end,
    ...
    -- Widgets popups
    awful.key({ altkey, }, "t", function () if beautiful.cal then beautiful.cal.show(7) end end,
    ...
    -- Copy primary to clipboard (terminal to gtk)
    --[[
    ...
    -- User programs
    awful.key({ altkey }, "q", function () awful.spawn(browser) end,
        {description = "run browser", group = "launcher"}
    ),
    awful.key({ altkey }, "n", function () awful.spawn(filemanager) end,
        { description = "run filemanager", group = "launcher"}
    ),

    -- print screen
    awful.key({ modkey }, "u", function () awful.spawn.with_shell(prtsc) end,
        { description = "print all screen", group = "hotkeys"}
    ),
    awful.key({ modkey, "Shift" }, "u", function () awful.spawn.with_shell(prtsc_custom) end, { description = "print screen custom", group = "hotkeys"}
    ),
    ...
    --]]
    --
    awful.key({ altkey }, "c", function () awful.spawn(rofi) end,
        { description = "show rofi", group = "launcher" }),
    --
    -- Prompt
...
clientkeys = mytable.join(
    ...
    awful.key({ altkey, "Shift"   }, "c",      function (c) c:kill()                         end,
