...
static const char *fonts[]          = {"Iosevka:style:medium:size=10" ,"JetBrainsMono Nerd Font Mono:style:medium:size=20" };
...
/* key definitions */
//#define MODKEY Mod4Mask // win as the modkey
#define MODKEY Mod1Mask // alt is the default modkey
...
static const Key keys[] = {
    ...
    {MODKEY|ControlMask,                XK_u,       spawn,
        ...
        SHCMD("maim -s $HOME/Pictures/Screenshots/$(date '+%Y-%m-%d-%H:%M:%S').png")},
    {MODKEY,                            XK_u,       spawn,
    ...
    { MODKEY,                           XK_comma,   focusmon,       {.i = -1 } },           // 聚焦上一个显示屏
    { MODKEY,                           XK_period,  focusmon,       {.i = +1 } },           // 聚焦下一个显示屏
    { MODKEY|ShiftMask,                 XK_comma,   tagmon,         {.i = -1 } },   // 窗口移动到上一个显示屏
